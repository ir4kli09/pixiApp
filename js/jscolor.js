        ...
        var jsc = {
            ...
            installBySelector: function (selector, rootNode) {
                ...
                for (var i = 0; i < elms.length; i += 1) {
                    ...
                    if (
                        (dataOpts = jsc.getDataAttr(elms[i], "jscolor")) !==
                            null ||
                        (elms[i].className &&
                            (m = elms[i].className.match(matchClass))) // installation using className (DEPRECATED)
                    ) {
                ...
                try {
                    ...
                    if (!jsc.pub.looseJSON) {
                        ...
                        try {
                            ...
                            throw new Error(
                                "Could not evaluate jscolor options: " + eEval
                            );
                        }
                    }
                }
            ...
            node: function (nodeOrSelector) {
                ...
                if (typeof nodeOrSelector === "string") {
                    ...
                    if (!el) {
                        console.warn(
                            "No element matches the selector: %s",
                            sel
                        );
                    }
                    return el;
            ...
            linearGradient: (function () {
                function getFuncName() {
                    ...
                    for (var i = 0; i < prefixes.length; i += 1) {
                        ...
                        var tryVal =
                            tryFunc +
                            "(to right, rgba(0,0,0,0), rgba(0,0,0,0))";
            ...
            genColorPreviewCanvas: function (
                ...
                if (start !== null) {
                    ...
                    for (
                        var i = 0;
                        i < jsc.pub.previewSeparator.length;
                        i += 1
                    ) {
                        ctx.beginPath();
            ...
            getPaletteDims: function (thisObj, width) {
                var cols = 0,
                    ...
                    cellH = 0,
                    height = 0;
                var sampleCount = thisObj._palette
                    ? thisObj._palette.length
                    : 0;
                ...
                if (sampleCount) {
                    ...
                    cellW = Math.max(
                        1,
                        Math.floor(
                            (width - (cols - 1) * thisObj.paletteSpacing) / cols
                        )
                    );
            ...
            pub: function (targetElement, opts) {
                ...
                this.channel = function (name, value) {
                    if (typeof name !== "string") {
                        throw new Error(
                            "Invalid value for channel name: " + name
                        );
                    }
                ...
                this.setPreviewElementBg = function (color) {
                    ...
                    if (!color) {
                        ...
                        backgrounds.push({
                            image: jsc.genColorPreviewGradient(
                                ...
                                position,
                                width
                                    ? width - jsc.pub.previewSeparator.length
                                    : null
                            ),
                            position: "left top",
                            size: "auto",
                        ...
                        var preview = jsc.genColorPreviewCanvas(
                            "rgba(0,0,0,0)",
                            position
                                ? { left: "right", right: "left" }[position]
                                : null,
                            width,
                            true
                        );
                    ...
                    if (position) {
                        padding[position] =
                            this.previewSize + this.previewPadding + "px";
                    }
                ...
                function setOption(option, value) {
                    if (typeof option !== "string") {
                        throw new Error(
                            "Invalid value for option name: " + option
                        );
                    }
                    ...
                    if (jsc.deprecatedOpts.hasOwnProperty(option)) {
                        ...
                        if (newOpt) {
                            ...
                            console.warn(
                                "Option '%s' is DEPRECATED, using '%s' instead." +
                                    jsc.docsRef,
                                oldOpt,
                                newOpt
                            );
                    ...
                    throw new Error(
                        "Unrecognized configuration option: " + option
                    );
                }
                ...
                function drawPicker() {
                    ...
                    p.padM.style.opacity = p.sldM.style.opacity = p.asldM.style.opacity =
                        "0";
                    ...
                    // alpha slider border
                    p.asldB.style.display = displayAlphaSlider
                        ? "block"
                        : "none";
                    ...
                    p.asldM.style.display = displayAlphaSlider
                        ? "block"
                        : "none";
                    ...
                    p.pal.style.display = pickerDims.palette.rows
                        ? "block"
                        : "none";
                    ...
                    for (var r = 0; r < pickerDims.palette.rows; r++) {
                        for (
                            var c = 0;
                            c < pickerDims.palette.cols &&
                            si < THIS._palette.length;
                            c++, si++
                        ) {
                            var sampleColor = THIS._palette[si];
                            var sampleCssColor = jsc.rgbaColor.apply(
                                null,
                                sampleColor.rgba
                            );
                            ...
                            sc.style.width =
                                pickerDims.palette.cellW -
                                2 * THIS.controlBorderWidth +
                                "px";
                            sc.style.height =
                                pickerDims.palette.cellH -
                                2 * THIS.controlBorderWidth +
                                "px";
                            ...
                            sw.style.top =
                                ...
                                "px";
                            sw.style.border =
                                THIS.controlBorderWidth + "px solid";
                            sw.style.borderColor = THIS.controlBorderColor;
                            sw.style.cursor = "pointer";
                            if (
                                sampleColor.rgba[3] !== null &&
                                sampleColor.rgba[3] < 1.0
                            ) {
                                // only create chessboard background if the sample has transparency
                                sw.style.backgroundImage =
                                    "url('" +
                                    chessboard.canvas.toDataURL() +
                                    "')";
                    ...
                    p.btnT.innerHTML = "";
                    p.btnT.appendChild(
                        window.document.createTextNode(THIS.closeText)
                    );
                ...
                function redrawPad() {
                    ...
                    var x = Math.round(
                        (THIS.channels.h / 360) * (THIS.width - 1)
                    );
                    var y = Math.round(
                    ...
                    switch (jsc.getSliderChannel(THIS)) {
                        case "s":
                            var rgb1 = jsc.HSV_RGB(
                                THIS.channels.h,
                                100,
                                THIS.channels.v
                            );
                            var rgb2 = jsc.HSV_RGB(
                                THIS.channels.h,
                                0,
                                THIS.channels.v
                            );
                ...
                function redrawSld() {
                    ...
                    if (sldChannel) {
                        ...
                        var y = Math.round(
                            (1 - THIS.channels[sldChannel] / 100) *
                                (THIS.height - 1)
                        );
                ...
                function redrawASld() {
                    var y = Math.round(
                        (1 - THIS.channels.a) * (THIS.height - 1)
                    );
                ...
                if (jsc.isButton(this.targetElement)) {
                    ...
                    if (jsc.isButtonEmpty(this.targetElement)) {
                        ...
                        var currMinWidth =
                            parseFloat(compStyle["min-width"]) || 0;
                ...
                if (this.value !== undefined) {
                    ...
                    this.valueElement &&
                    this.valueElement.value !== undefined
                ) {
                ...
                if (this.alpha !== undefined) {
                    ...
                    this.alphaElement &&
                    this.alphaElement.value !== undefined
                ) {
